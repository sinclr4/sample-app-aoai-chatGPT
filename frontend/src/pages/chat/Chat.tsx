...
import Contoso from "../../assets/nhs.svg";
                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer your questions about content on <a href="https://www.nhs.uk">The NHS Website</a></h2>
                            </Stack>
                        ) : (
